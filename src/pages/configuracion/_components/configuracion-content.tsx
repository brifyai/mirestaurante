...
¡Gracias! 🙏`,
  ...
  const saveConfiguration = async () => {
    ...
    try {
      ...
      console.log(
        "Google Analytics apiKey:",
        apiConfigs.googleAnalytics?.apiKey,
      );
      console.log(
        "Google Analytics measurementId:",
        apiConfigs.googleAnalytics?.measurementId,
      );
    ...
    <div className="p-6 max-w-7xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-gray-600">
          Sistema completo de integraciones API para AI Restaurante
        </p>
      </div>
      ...
      >
        ...
        <TabsContent value="apis" className="space-y-6">
          <Alert>
            ...
            <AlertDescription>
              Configure las APIs necesarias para que AI Restaurante funcione
              completamente. Todas las integraciones son necesarias para el
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleApiKeyChange("whatsapp", e.target.value)
                      }
                    />
                  </div>
                  <div>
              ...
              <div className="border rounded-lg p-4 space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Input type="password" placeholder="EAAxxxxxxxxxxxxx..." />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleApiKeyChange("facebook", e.target.value)
                      }
                    />
                  </div>
                  <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleApiKeyChange("googleCalendar", e.target.value)
                      }
                    />
                  </div>
                  <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleApiKeyChange("googleAnalytics", e.target.value)
                      }
                    />
                  </div>
                  <div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <Alert>
                ...
                <AlertDescription>
                  Conecta tu restaurante con Google Places para obtener
                  información actualizada y habilitar funciones de reseñas
                  automáticas.
                </AlertDescription>
              </Alert>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleApiKeyChange("googlePlaces", e.target.value)
                    }
                  />
                </div>
                <div>
                ...
                <Button
                  ...
                  onClick={() => {
                    if (apiConfigs.googlePlaces.webhook) {
                      window.open(
                        `https://www.google.com/maps/place/?q=place_id:${apiConfigs.googlePlaces.webhook}`,
                        "_blank",
                      );
                    }
                  }}
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>
                    Solicitudes automáticas de reseñas en Google después de cada
                    reserva
                  </CardDescription>
                </div>
            ...
            <CardContent className="space-y-6">
              <Alert>
                ...
                <AlertDescription>
                  Sistema completo que envía solicitudes de reseñas
                  automáticamente 2 horas después de cada reserva, con
                  incentivos personalizados y seguimiento de conversión.
                </AlertDescription>
              </Alert>
              ...
              <div className="border rounded-lg p-4 space-y-4 bg-red-50 border-red-200">
                ...
                <Alert>
                  ...
                  <AlertDescription>
                    Para que funcionen las reseñas automáticas, necesitas
                    configurar estas APIs de Google.
                  </AlertDescription>
                </Alert>
                ...
                <div className="grid grid-cols-1 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleApiKeyChange("googleReviews", e.target.value)
                      }
                    />
                  ...
                  <ol className="text-sm text-yellow-800 space-y-1">
                    <li>
                      ...
                      <a
                        ...
                        className="underline"
                      >
                        Habilita Google My Business API
                      </a>
                    </li>
                    <li>
                      2.{" "}
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-600">
                        Códigos de descuento por reseñar
                      </p>
                    </div>
                  </div>
                  <div>
              ...
              <div className="border rounded-lg p-4 space-y-4">
                ...
                <div className="bg-yellow-50 p-3 rounded-lg">
                  <p className="text-sm text-yellow-800">
                    <strong>Variables disponibles:</strong> {"{nombre}"},{" "}
                    {"{restaurante}"}, {"{codigo_descuento}"}, {"{link_resena}"}
                  </p>
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-600">
                        Probar diferentes mensajes automáticamente
                      </p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-600">
                        Solo enviar a clientes probablemente satisfechos
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>
                    {aiSettings.model ? `${aiSettings.model} - ` : ""}Motor de
                    inteligencia artificial principal
                  </CardDescription>
                </div>
            ...
            <CardContent className="space-y-4">
              <Alert>
                ...
                <AlertDescription>
                  Esta es la IA que procesará todas las conversaciones y tomará
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      La IA responde automáticamente a consultas simples
                    </p>
                  </div>
                  <Switch
        ...
        <TabsContent value="mensajes" className="space-y-6">
          <Alert>
            ...
            <AlertDescription>
              Configure los mensajes que se envían automáticamente a los
              clientes cuando escanean QR, después de su visita, y para
              incentivar su retorno.
            </AlertDescription>
          </Alert>
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>
                    Mensaje que se envía automáticamente cuando el cliente
                    escanea el QR
                  </CardDescription>
                </div>
                <Switch
            ...
            <CardContent className="space-y-6">
              <div>
                ...
                />
                <p className="text-xs text-gray-500 mt-1">
                  Variables disponibles: {"{nombre_restaurante}"},{" "}
                  {"{cliente_nombre}"}
                </p>
              </div>
              ...
              <div className="border rounded-lg p-4 space-y-4 bg-green-50">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Agregar botón interactivo para enviar la carta
                    </p>
                  </div>
                  <Switch
                ...
                {whatsappMessages.welcomeMessage.includeMenuButton && (
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="flex items-center space-x-2 pt-6">
                      <Switch
                        checked={
                          whatsappMessages.welcomeMessage.sendMenuAfterButton
                        }
                        onCheckedChange={(checked) =>
                          setWhatsappMessages((prev) => ({
                            ...prev,
                            welcomeMessage: {
                              ...prev.welcomeMessage,
                              sendMenuAfterButton: checked,
                            },
                          }))
                        }
                      />
                      <Label className="text-sm">
                        Enviar carta automáticamente al hacer clic
                      </Label>
                    </div>
                  </div>
                )}
            ...
            <CardContent className="space-y-6">
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setWhatsappMessages((prev) => ({
                        ...
                        menuDelivery: {
                          ...prev.menuDelivery,
                          format: value as "pdf" | "image" | "text",
                        },
                      }))
                    }
                  >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <Label className="text-sm">
                    Incluir descripciones de platos
                  </Label>
                </div>
                <div className="flex items-center space-x-2">
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      setWhatsappMessages((prev) => ({
                        ...
                        menuDelivery: {
                          ...prev.menuDelivery,
                          includeAllergens: checked,
                        },
                      }))
                    }
                  />
                  <Label className="text-sm">
                    Incluir información de alergenos
                  </Label>
                </div>
              </div>
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>
                    Mensaje con descuento que se envía automáticamente después
                    de la visita
                  </CardDescription>
                </div>
                <Switch
            ...
            <CardContent className="space-y-6">
              ...
              <div>
                ...
                />
                <p className="text-xs text-gray-500 mt-1">
                  Variables: {"{fecha_expiracion}"}, {"{codigo_descuento}"},{" "}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex items-center space-x-2">
                  <Switch
                    checked={
                      whatsappMessages.returnIncentive.generateUniqueCode
                    }
                    onCheckedChange={(checked) =>
                      setWhatsappMessages((prev) => ({
                        ...prev,
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-600">
                      Crear código único por cliente
                    </p>
                  </div>
                </div>
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-600">
                      Rastrear si se usó el descuento
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  <div className="text-sm whitespace-pre-line">
                    {whatsappMessages.returnIncentive.message
                      .replace(
                        ...
                        new Date(
                          Date.now() +
                            whatsappMessages.returnIncentive.validityDays *
                              24 *
                              60 *
                              60 *
                              1000,
                      ...
                      .replace(
                        "{porcentaje_descuento}",
                        whatsappMessages.returnIncentive.discountPercentage.toString(),
                      )}
                  </div>
                </div>
              </div>
                ...
                <div key={index} className="border rounded-lg p-4 space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <Button
                      ...
                      onClick={() => {
                        const newMessages =
                          whatsappMessages.followUpMessages.messages.filter(
                            (_, i) => i !== index,
                          );
                        setWhatsappMessages((prev) => ({
                          ...prev,
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => {
                          const newMessages = [
                            ...whatsappMessages.followUpMessages.messages,
                          ];
                          newMessages[index] = {
                            ...newMessages[index],
        ...
        <TabsContent value="whatsapp" className="space-y-6">
          <Alert>
            ...
            <AlertDescription>
              WhatsApp será el canal principal donde los clientes podrán
              realizar todas las gestiones. Configure qué funcionalidades
              estarán disponibles.
            </AlertDescription>
          </Alert>
                ...
                {whatsappFeatures.map((feature) => (
                  ...
                  >
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        {feature.id === "menu" &&
                          "Envío automático de carta y especialidades"}
                        {feature.id === "reservations" &&
                          "Crear, modificar y cancelar reservas"}
                        {feature.id === "allergies" &&
                          "Consultas sobre ingredientes y alergias"}
                        {feature.id === "promotions" &&
                          "Información sobre ofertas activas"}
                        {feature.id === "hours" &&
                          "Horarios de atención y disponibilidad"}
                        {feature.id === "location" &&
                          "Dirección, mapa y contacto"}
                        {feature.id === "events" &&
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  />
                  <p className="text-xs text-gray-500 mt-1">
                    Clave secreta para validar webhooks
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Tiempo máximo de espera para respuestas API
                  </p>
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Guardar logs completos de conversaciones
                    </p>
                  </div>
                  <Switch defaultChecked />
                </div>
      ...
      <div className="flex justify-end space-x-3 pt-6 border-t">
        <Button
          ...
          onClick={() => {
            if (
              window.confirm(
                "¿Estás seguro de que deseas restaurar todos los valores por defecto? Esta acción no se puede deshacer.",
              )
            ) {
